...
local function advance(self: ParticleSystemNode, seconds: number): boolean
	...
	for i = 1, #parts do
        ...
        if p.isGroupPoint then
            ...
            local animSpeed = dt -- 1.0s duration
    ...
    -- Process Spawning Queue with Delay
    if self.positionsCaptured and #self.pendingGroupClusters > 0 then
